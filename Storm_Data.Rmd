...
###### EXHIBIT 7: Economic Outlier Adjustment (Top 20 Event Types)
...
fatality.adj.smry <- 
      ...
      group_by(EVENT_TYPE) %>%
      summarize(FATALITY_INIT = sum(FATALITIES), TTL_ADJ = sum(FATALITY_ADJ))
fatality.adj.smry <- fatality.adj.smry[order(fatality.adj.smry$FATALITY_INIT, 
                                                            decreasing = TRUE),]
```
